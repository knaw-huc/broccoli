...
//            addBundle(getSwaggerBundle())
    ...
    /*
    private fun getSwaggerBundle(): ConfiguredBundle<in BroccoliConfiguration?> = object : SwaggerBundle<BroccoliConfiguration>(),
        ConfiguredBundle<BroccoliConfiguration?> {
